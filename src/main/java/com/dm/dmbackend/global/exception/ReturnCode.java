package com.dm.dmbackend.global.exception;
...
public enum ReturnCode {
    ...
    // Auth (400/401/403/404/409 적절 배치)
    ...
    INVALID_RESET_TOKEN(400, "USER_015", "비밀번호 재설정 토큰이 올바르지 않습니다."),
    ...
    MEMBER_ALREADY_EXISTS(409, "CHATROOM_004", "이미 채팅방에 존재하는 사용자입니다."),
