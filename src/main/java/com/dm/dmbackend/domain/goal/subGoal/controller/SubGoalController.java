...
public class SubGoalController {
    ...
    public ApiResponse<Void> addSubGoal(@RequestBody @Valid SubGoalRequest subGoalRequest, @LoginUser LoginUserDto loginUser){
    ...
    public ApiResponse<Void> deleteSubGoal(@PathVariable("subGoalId") Long subGoalId, @LoginUser LoginUserDto loginUser){
